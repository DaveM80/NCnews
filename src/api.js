...
export const patchVotes = (voteValue, item_id, voteOn) => {
  return Axios.patch(`${baseURL}/${voteOn}/${item_id}`, {
    inc_votes: voteValue
  });
};
...
export const getArticleByID = article_id => {
  return Axios.get(
    `https://nc-news-davem80.herokuapp.com/api/articles/${article_id}`
  );
};

export const postComment = (article_id, body) => {
  return Axios.post(`${baseURL}/articles/${article_id}/comments`, body);
};
